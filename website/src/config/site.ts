export const SITE = {
  ...
  description: 'Editorial Intelligence helps organisations understand what they know, identify what they still need to learn and turn evidence into ideas that influence decisions.',
