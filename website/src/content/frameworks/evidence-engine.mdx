...
<div class="sources-diagram">
  <div class="sources-engine">
    <span class="sources-engine-sub">Conversation → transcript → signals → connections → reusable evidence</span>
  </div>
</div>
...
*Connected frameworks: [Editorial Intelligence](/intelligence) · [Narrative Architecture](/frameworks/narrative-architecture) · [Editorial Activation](/frameworks/editorial-activation) · [AI Visibility & Buyability](/frameworks/ai-visibility-buyability) · [Daily OS](/frameworks/daily-os) · [EI for product teams](/frameworks/editorial-intelligence-product-management)*
